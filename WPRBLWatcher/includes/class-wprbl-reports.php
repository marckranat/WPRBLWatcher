...
class WPRBL_Reports {
    ...
    public function send_email_report($user_id, $email, $report_type = 'daily') {
        ...
        // Use WordPress filters to set from email and name (more reliable)
        $from_filter = function($from) use ($from_email) {
            return $from_email;
        };
        ...
        $headers = [
            ...
            'From: RBL Watcher <' . $from_email . '>',
            'Reply-To: ' . $from_email
        ];
        
        $sent = wp_mail($email, $subject, $html, $headers);
        
        // Remove our filters after sending (don't affect other plugins)
